...
<section>
    <div class="wrap">
        <div class="left">
            ...
            <ul>
                <c:forEach items = "${ani_infolist}" var = "info">
                    <li>
        ...
        <div class="right">
            <div class="h1">热播榜</div>
            <ul>
                <c:forEach items="${top_infolist}" var="info">
                    <li><a href="/Specific?name=${info.name}&&num=${info.last_num}&&prenum=1" title="${info.name}">
                        <span class="qt">最新:${info.last_num}集</span>
                        <span class="i i4">${info.priority}</span>
                        "${info.name}"
                    </a></li>
                </c:forEach>
